...
export default function EnquiriesPage() {
  ...
  const fetchEnquiries = async () => {
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "فشل في جلب الاستفسارات");
      }

      setEnquiries(data.enquiries);
    } catch (error) {
      toast.error('خطأ في جلب الاستفسارات');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-gray-600">جاري تحميل استفساراتك...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">استفساراتي</h1>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex justify-between items-center text-sm text-gray-500">
                    ...
                    <div>
                      {user._id === enquiry.sender._id ? (
                        <span>لقد أرسلت هذا الاستفسار</span>
                      ) : (
                        <Link
