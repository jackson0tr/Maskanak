          ...
          <div className="max-w-lg w-full backdrop-blur-lg bg-white/10 rounded-2xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 text-lg">
                الرجاء تسجيل الدخول لبدء إضافة عقارك إلى سوقنا
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">القائمة المهنية</h3>
                  <p className="text-gray-300 text-sm">اعرض عقارك بقوائم عالية الجودة</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-[#ffa509]/20 p-2 rounded-lg">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">وصول واسع</h3>
                  <p className="text-gray-300 text-sm">تواصل مع الآلاف من المشترين المحتملين</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 mb-8">
          <h1 className="text-4xl font-bold text-white mb-2 flex items-center">
            <FaHome className="ml-3 text-[#ffa509]" />
            إضافة عقار جديد
          </h1>
          <p className="text-gray-300">قم بملء التفاصيل أدناه لإدراج ممتلكاتك</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <MdTitle className="ml-2 text-[#ffa509]" />
              المعلومات الأساسية
            </h2>
            <div className="grid grid-cols-1 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                  <MdDescription className="ml-2 text-[#ffa509]" />
                  وصف
                </label>
                <textarea
                  name="description"
                  ...
                  rows={4}
                  className="w-full rounded-xl bg-white/5 border-2 border-[#ffa509]/20 text-white px-4 py-3 focus:outline-none focus:border-[#ffa509] transition-colors placeholder-gray-500"
                  placeholder="وصف ممتلكاتك"
                />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                  <FaMoneyBillWave className="ml-2 text-[#ffa509]" />
                  سعر
                </label>
                <input
                  type="number"
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <FaHome className="ml-2 text-[#ffa509]" />
              تفاصيل العقار
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                  <FaBuilding className="ml-2 text-[#ffa509]" />
                  نوع العقار
                </label>
                <select
                  name="propertyType"
                ...
                >
                  <option className='bg-white/5 text-black' value="منزل">منزل</option>
                  <option className='bg-white/5 text-black' value="شقة">شقة</option>
                  <option className='bg-white/5 text-black' value="فيلا">فيلا</option>
                  <option className='bg-white/5 text-black' value="تاون هاوس">تاون هاوس</option>
                  <option className='bg-white/5 text-black' value="أرض">أرض</option>
                  <option className='bg-white/5 text-black' value="تجاري">تجاري</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl bg-white/5 border-2 border-[#ffa509]/20 text-white px-4 py-3 focus:outline-none focus:border-[#ffa509] transition-colors"
                >
                  <option className='bg-white/5 text-black' value="For Sale">للبيع</option>
                  <option className='bg-white/5 text-black' value="For Rent">للإيجار</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                  <FaBed className="ml-2 text-[#ffa509]" />
                  غرف نوم
                </label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                  <FaBath className="ml-2 text-[#ffa509]" />
                  الحمامات
                </label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                  <FaRulerCombined className="ml-2 text-[#ffa509]" />
                  المساحة (قدم مربع)
                </label>
                <input
                  type="number"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center bg-white/5 rounded-xl p-4 border-2 border-[#ffa509]/20">
                ...
                />
                <label className="mr-3 flex items-center text-gray-300">
                  <FaParking className="ml-2 text-[#ffa509]" />
              ...
              <div className="flex items-center bg-white/5 rounded-xl p-4 border-2 border-[#ffa509]/20">
                ...
                />
                <label className="mr-3 flex items-center text-gray-300">
                  <FaCouch className="ml-2 text-[#ffa509]" />
                  مفروشة
                </label>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <FaMapMarkerAlt className="ml-2 text-[#ffa509]" />
              عنوان
            </h2>
            <div className="grid grid-cols-1 gap-6">
              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                    <MdLocationCity className="ml-2 text-[#ffa509]" />
                    مدينة
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2 flex items-center">
                    <BiWorld className="ml-2 text-[#ffa509]" />
                    دولة
                  </label>
                  <input
                    type="text"
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <FaUpload className="ml-2 text-[#ffa509]" />
              صور العقار
            </h2>
            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-[#ffa509]/20 border-dashed rounded-xl bg-white/5">
              <div className="space-y-2 text-center">
                ...
                <div className="flex text-sm text-gray-300">
                  ...
                  <p className="pr-3 pt-2">أو السحب والإفلات</p>
                </div>
                <p className="text-xs text-gray-400">PNG، JPG، GIF بحجم يصل إلى 10 ميجا بايت</p>
              </div>
            </div>
          ...
          <div className="flex justify-end">
            ...
            >
              <FaHome className="text-lg" />
              {loading ? 'جاري اناء العقار...' : 'إنشاء عقار'}
            </button>
          </div>
        </form>
      </div>
