...
export default function EditProperty({ params }) {
  ...
  if (loading) {
    return <div className="text-center py-4">جاري تحميل تفاصيل الملكية...</div>;
  }
        ...
        <div className="backdrop-blur-lg bg-white/10 rounded-xl p-8 shadow-xl mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="backdrop-blur-lg bg-white/5 rounded-lg p-6 space-y-6">
              <h2 className="text-2xl font-semibold text-[#ffa509] mb-4">المعلومات الأساسية</h2>
            ...
            <div className="backdrop-blur-lg bg-white/5 rounded-lg p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-2">شارع</label>
                  <input
                    type="text"
                    name="address.street"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-2">مدينة</label>
                  <input
                    type="text"
                    name="address.city"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-2">ولاية</label>
                  <input
                    type="text"
                    name="address.state"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-2">الرمز البريدي</label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-200 mb-2">دولة</label>
                  <input
                    type="text"
