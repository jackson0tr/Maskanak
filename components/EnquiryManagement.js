          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                تلقى ({enquiries.received?.length || 0})
              </button>
              <button
        ...
        <div className="grid gap-6">
          {displayEnquiries?.length > 0 ? (
                  ...
                  <div className="flex-grow w-full text-white">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                      ...
                      {activeTab === "received" && (
                        ...
                        >
                          <option value={VALID_STATUSES.PENDING}>⏳ قيد الانتظار</option>
                          <option value={VALID_STATUSES.CONTACTED}>📞 تم الاتصال به</option>
                          <option value={VALID_STATUSES.RESOLVED}>✅ تم الحل</option>
                          <option value={VALID_STATUSES.ARCHIVED}>📁 مؤرشف</option>
                        </select>
                      )}
                    </div>
                    ...
                    <div className="bg-[#050b2c]/50 rounded-xl p-4">
                      <p className="text-gray-300 flex items-center mb-3">
                        ...
                        <span className="font-semibold">رسالة:</span>
                      </p>
            ...
            <div className="text-center py-16 bg-white/10 backdrop-blur-lg rounded-2xl">
              ...
              <p className="text-2xl text-white">لم يتم العثور على أي استفسارات</p>
              <p className="text-gray-300 mt-2">لك {activeTab} ستظهر الاستفسارات هنا</p>
            </div>
          )}
        </div>
      </div>
